...
# Contributing to DCP's Documentation
...
[Issues](https://github.com/Distributive-Network/dcp-docs//issues) that might
...
- Open an [Issue](https://github.com/Distributive-Network/dcp-docs//issues/new).
...
- To see if other users have experienced (and potentially already solved) the
  ...
  [bug tracker](https://github.com/Distributive-Network/dcp-docs/issues?q=label%3Abug).
...
This section guides you through submitting an enhancement suggestion for DCP's
Documentation, **including completely new features and minor improvements to
...
- Perform a [search](https://github.com/Distributive-Network/dcp-docs//issues)
...
[GitHub issues](https://github.com/Distributive-Network/dcp-docs//issues).
...
- **Explain why this enhancement would be useful** to most DCP's Documentation
